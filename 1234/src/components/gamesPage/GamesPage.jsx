        ...
        <Col className="d-flex justify-content-between">
          <Card style={{ width: '18rem' }}>
            <Card.Body>
              ...
              <Button variant="primary" href="rslang/game/audiocall">
                Начать игру
              </Button>
            </Card.Body>
          </Card>
          <Card style={{ width: '18rem' }}>
            <Card.Body>
              ...
              <Card.Text>Выберите правильный перевод слова.</Card.Text>
              <Button variant="primary" href="rslang/game/sprint">
                Начать игру
              </Button>
            </Card.Body>
          </Card>
          <Card style={{ width: '18rem' }}>
            <Card.Body>
              ...
              <Button variant="primary" href="rslang/game/wordAssociation">
                Начать игру
              </Button>
            </Card.Body>
          </Card>
