...
const sidebarItems = [
  ...
  { name: 'Textbook', icon: <MenuBookIcon />, url: '/rslang/textbook' },
  { name: 'Game', icon: <SportsEsportsIcon />, url: '/rslang/game' },
  { name: 'Statistics', icon: <EqualizerIcon />, url: '/rslang/statistics' }
];
